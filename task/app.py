...
class MicrowaveRAG:
    ...
    def _setup_vectorstore(self) -> VectorStore:
        ...
        index_path = script_dir / "microwave_faiss_index"
    ...
    def _create_new_index(self) -> VectorStore:
        ...
        script_dir = Path(__file__).parent
        loader = TextLoader(
            file_path=str(script_dir / "microwave_manual.txt"),
            encoding="utf-8"
        )
    ...
    def retrieve_context(self, query: str, k: int = 4, score=0.3) -> str:
        ...
        for i, (doc, result_score) in enumerate(results, 1):
            context_parts.append(doc.page_content)
            print(f"\n📄 Chunk {i} (Score: {result_score:.4f}):")
